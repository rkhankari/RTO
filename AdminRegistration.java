...
{
	public static String stringFullName,stringAdmin_Id,stringAddress,stringContactNo,gender,stringEmail,stringDOB,stringBloodGrp,stringQualification,stringAadharNo,stringAdmin_Name,stringPassword;
	
   public JLabel lb_Title, lb_note, lb_gender,lb_adminid,lb_email,  lb_name, lb_DOB, lb_add, lb_mob, lb_courses,lb_Aadhar, lb_AName ,lb_pass,lb_bloodgroup,lb_q3,lb_qualification;
	public  JLabel lb_hint0, lb_hint1, lb_hint2, lb_hint3, lb_hint4, lb_hintFinal,show1;	//Label for showing text field
	public  JTextField tf_name, tf_DOB, tf_mob,tf_adminid,tf_email, tf_AName, tf_pass,tf_bloodgroup,tf_q3,tf_qualification,tf_Aadhar;
...
//1)Labels
		...
		lb_Title.setBounds(150, 40, 450, 20);
...
/*//side error firing
		...
		add(lb_hint1);*/
//admin id
		lb_adminid = new JLabel("* ADMIN ID:");		
		lb_adminid.setBounds(50, 110, 100, 20);
		add(lb_adminid);
		
		//1)TextFields
		//name
		tf_adminid = new JTextField();
		tf_adminid.setBounds(190, 110, 300, 20);
		add(tf_adminid);
...
//2)RadioButton
		...
		rb1.setBounds(110, 140, 60, 20);
		
		//radioButton2
		rb2 = new JRadioButton("Female");
		rb2.setBounds(180, 140, 80, 20);
...
//DOB
 ...
 //qualification
				...
				tf_qualification.setBounds(190, 340, 300, 20);
						...
						//User name
						lb_AName = new JLabel("* Admin Name:");		
						lb_AName.setBounds(50, 460, 200, 20);
						add(lb_AName);
						
				//Text Field User name
						tf_AName = new JTextField();		
						tf_AName.setBounds(190, 460, 300, 20);
								add(tf_AName);
...
private void validatePassword(String password) 
{
	...
	{
		   InsertDatabaseAdminRegistration();
	...
	/*if(obj.getSource()==btnSubmit)
		{
			...
			else if(tf_AName.getText().isEmpty())
			{
...
private void InsertDatabaseAdminRegistration() {
	// TODO Auto-generated method stub
	stringFullName= tf_name.getText();
	stringAdmin_Id= tf_adminid.getText();
//	gender=	rb2.getText();
	if(rb1.isSelected())
	{
		gender= rb1.getText();
	...
	stringAdmin_Name=tf_AName.getText();
	stringPassword = tf_pass.getText();
	//.toString();
	
	String sql="insert into adminregistration(Full_Name, Admin_Id, Gender, Permanent_Address, Email_Id, Contact_No, DOB, Qualification, Blood_Grp, Aadhar_No, Admin_Name, Password) values(?,?,?,?,?,?,?,?,?,?,?,?)";
			try{
		...
		ps.setString(11, stringAdmin_Name );
