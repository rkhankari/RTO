...
public class LicenseApplicationChoice extends JFrame implements ActionListener
...
LicenseApplicationChoice()
{
    //frame
	super(" LicenseApplicationChoice");
	setLayout(null);
	setSize(1050,800);
	
	//Title Label
	lb_Title = new JLabel("WELCOME TO RTO LICENSE APPLICATION");
	...
	btnExistingUserLogin = new JButton("License Application");
	btnExistingUserLogin.setBounds(180, 250, 200, 40);
	add(btnExistingUserLogin);
	btnExistingUserLogin.addActionListener(this);
	btnExistingUserLogin.setActionCommand("License Application");	//Add action listener to btnCancel
