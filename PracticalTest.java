...
public class PracticalTest  extends JFrame implements ActionListener
{
	...
	PracticalTest()
	{
		...
		//1)Labels
				...
				//title
				lb_title = new JLabel("*****PRACTICAL TEST FORM*****");
		...
		//time
				...
				lb_time.setBounds(50, 110, 100, 20);
				add(lb_time);
...
*/
	...
	private void InsertDatabasePracticalTest() 
	{
		// TODO Auto-generated method stub
		...
		String sql="insert into practicaltest(stringDate,stringTime,stringAddress)values(?,?,?) ";
