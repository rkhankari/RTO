...
public class TableViewTestApplication extends JFrame implements ActionListener
{
    ...
    TableViewTestApplication()
    {
    	
        super("TableViewTestApplication Entry");
        setSize(1350,800);
        setLayout(null);
    	createGUI();
    ...
    private void createGUI() {
      ...
      //  eastPanel.add(btnAdd);
        ...
        JLabel lb1Field0 = new JLabel("Test Application Details");
        JLabel lblField1 = new JLabel("Username");
        JLabel lblField2 = new JLabel("Password");
        JLabel lblField3 = new JLabel("Test_Type");
        ...
        tableModel = new DefaultTableModel(new Object[]{"Username","Password","Test_Type"},0);
...
//insert into tbl_institute(col_id,col_course,col_fees,col_duration,col_staff)values(1,'java','5000','2months','kanchan');
			while(rs.next())
		        ...
		        tableModel.addRow(new Object[]{stringUsername,stringPassword,stringTestType });
				}
			con.close();
	...
	public static void main(String[] args) 
	{
		SwingUtilities.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
            	TableViewTestApplication frm = new TableViewTestApplication();
